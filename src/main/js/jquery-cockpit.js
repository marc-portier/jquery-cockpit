...
( function( $) {
    ...
    ExchangeIndicator.config = {
        ...
        "background-border" :   0,
        "volume-max"        :  50,
        "in-fill"           : "rgba(  0,200,  0, 0.5)",
        "in-stroke"         : "rgba(  0,255,  0, 0.8)",
        "in-border"         :   1,
        "ex-fill"           : "rgba(200,200,100, 0.5)",
        "ex-stroke"         : "rgba(200,200,100, 0.8)",
        "ex-border"         :   1,
        "out-fill"          : "rgba(200,  0,  0, 0.5)",
        "out-stroke"        : "rgba(255,  0,  0, 0.8)",
        "out-border"        :   1,
